...
export default function Recommender() {
    ...
    function formSubmission() {
        ...
        try {
            ...
            for (let item in dict) {    //Logic for selecting applicable menu items
                if (((ltgtcalories === "lessthan") && (dict[item].Calories <= parseInt(calories)) && (dict[item].Calories !== "")) || ((ltgtcalories === "greaterthan") && (dict[item].Calories >= parseInt(calories)) && (dict[item].Calories !== ""))) {
                    if (((ltgtprotein === "lessthan") && (dict[item].ProteinGrams <= parseInt(protein)) && (dict[item].ProteinGrams !== "")) || ((ltgtprotein === "greaterthan") && (dict[item].ProteinGrams >= parseInt(protein)) && (dict[item].ProteinGrams !== ""))) {
                        if (((ltgtfat === "lessthan") && (dict[item].FatGrams <= parseInt(fat)) && (dict[item].FatGrams !== "")) || ((ltgtfat === "greaterthan") && (dict[item].FatGrams >= parseInt(fat)) && (dict[item].FatGrams !== ""))) {
                            if (((ltgtcarbs === "lessthan") && (dict[item].CarbsGrams <= parseInt(carbs)) && (dict[item].CarbsGrams !== "")) || ((ltgtcarbs === "greaterthan") && (dict[item].CarbsGrams >= parseInt(carbs)) && (dict[item].CarbGrams !== ""))) {
                                ...
                                recipe_container.appendChild(list_item);
                            }
                        }
                    }
                }
            ...
            message.appendChild(message_item);
